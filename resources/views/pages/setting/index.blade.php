                ...
                <form enctype="multipart/form-data" method="post" action="{{route('settings.update','test')}}">
                    ...
                    <div class="row">
                        <div class="col-md-6 border-right-2 border-right-blue-400">
                            ...
                            <div class="form-group row">
                                <label for="current_session" class="col-lg-2 col-form-label font-weight-semibold">Current Academic Year<span class="text-danger">*</span></label>
                                <div class="col-lg-9">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-lg-9">
                                    <input name="school_title" value="{{ $setting['school_title'] }}" type="text" class="form-control" placeholder="School Title">
                                </div>
                            </div>
                            <div class="form-group row">
                            ...
                            <div class="form-group row">
                                <label class="col-lg-2 col-form-label font-weight-semibold">School Email</label>
                                <div class="col-lg-9">
                            ...
                            <div class="form-group row">
                                <label class="col-lg-2 col-form-label font-weight-semibold">End of First Term</label>
                                <div class="col-lg-9">
                                    <input name="end_first_term" value="{{ $setting['end_first_term'] }}" type="text" class="form-control date-pick" placeholder="Date Term Ends">
                                </div>
                            </div>
                            <div class="form-group row">
                                <label class="col-lg-2 col-form-label font-weight-semibold">End of Second Term</label>
                                <div class="col-lg-9">
