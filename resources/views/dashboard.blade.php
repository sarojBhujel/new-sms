                        ...
                        <div class="card-body">
                            ...
                            <p class="text-muted pt-3 mb-0 mt-2 border-top">
                                <i class="fas fa-binoculars mr-1" aria-hidden="true"></i><a
                                    href="{{ route('Students.index') }}" target="_blank"><span class="text-danger">View Data</span></a>
                            </p>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="card card-statistics h-100">
                        <div class="card-body">
                            <div class="clearfix">
                                ...
                                <div class="float-right text-right">
                                    <p class="card-text text-dark">Total Teachers</p>
                                    <h4>{{ \App\Models\Teacher::count() }}</h4>
                                </div>
                            </div>
                            <p class="text-muted pt-3 mb-0 mt-2 border-top">
                                <i class="fas fa-binoculars mr-1" aria-hidden="true"></i><a
                                    href="{{ route('Teachers.index') }}" target="_blank"><span class="text-danger">View Data</span></a>
                            </p>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="card card-statistics h-100">
                        <div class="card-body">
                            <div class="clearfix">
                                ...
                                <div class="float-right text-right">
                                    <p class="card-text text-dark">Total Parents</p>
                                    <h4>{{ \App\Models\My_Parent::count() }}</h4>
                                </div>
                            </div>
                            <p class="text-muted pt-3 mb-0 mt-2 border-top">
                                <i class="fas fa-binoculars mr-1" aria-hidden="true"></i><a
                                    href="{{ route('add_parent') }}" target="_blank"><span class="text-danger">View Data</span></a>
                            </p>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="card card-statistics h-100">
                        <div class="card-body">
                            <div class="clearfix">
                                ...
                                <div class="float-right text-right">
                                    <p class="card-text text-dark">Total Classrooms</p>
                                    <h4>{{ \App\Models\Section::count() }}</h4>
                                </div>
                            </div>
                            <p class="text-muted pt-3 mb-0 mt-2 border-top">
                                <i class="fas fa-binoculars mr-1" aria-hidden="true"></i><a
                                    href="{{ route('Sections.index') }}" target="_blank"><span class="text-danger">View Data</span></a>
                            </p>
                        </div>
                    </div>
                </div>
                            ...
                            <div class="tab nav-border" style="position: relative;">
                                <div class="d-block d-md-flex justify-content-between">
                                    <div class="d-block w-100">
                                        <h5 style="font-family: 'Cairo', sans-serif" class="card-title">Recent System Activity</h5>
                                    </div>
                                            ...
                                            <table style="text-align: center"
                                                ...
                                                <tbody>
                                                    @forelse(\App\Models\Student::latest()->take(5)->get() as $student)
                                                        ...
                                                        @empty
                                                            <td class="alert-danger" colspan="8">No Data Available</td>
                                                        </tr>
                                                    @endforelse
                                                </tbody>
                                            </table>
                                        ...
                                        <div class="table-responsive mt-15">
                                            <table style="text-align: center"
                                                ...
                                                <tbody>
                                                    ...
                                                    @empty
                                                        <tr>
                                                            <td class="alert-danger" colspan="9">No Data Available</td>
                                                        </tr>
                                                    @endforelse
                                                </tbody>
                                            </table>
